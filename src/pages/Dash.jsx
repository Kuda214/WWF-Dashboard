...
export default function Dashboard() {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-[94vh] space-y-6">
      {/* 1. FILTER BAR */}
      <div className="w-full bg-gray-200 p-4 rounded shadow flex flex-wrap items-center justify-between gap-4">
      ...
      >
        {visible.map && (
          <div className="bg-white p-4 rounded shadow relative">
            <div className="absolute top-2 left-2 bg-green-600 text-white text-xl font-bold px-3 py-1 rounded">
              12.4%
            </div>
          ...
          <div className="bg-white p-4 rounded shadow">
            ...
            <div className="grid gap-4">
              <div className="bg-blue-50 p-4 rounded shadow-sm">
                <h4 className="font-medium text-md">Update Contractor Agreement</h4>
                <p className="text-sm text-gray-600">Due: 22 July | Status: Pending</p>
              </div>
              <div className="bg-blue-50 p-4 rounded shadow-sm">
                <h4 className="font-medium text-md">Plan for Next Year</h4>
      ...
      >
        {visible.assigned && (
          <div className="bg-white p-4 rounded shadow flex flex-col h-[32vh]">
