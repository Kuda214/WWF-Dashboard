...
const COLORS = ['#8e44ad', '#e74c3c', '#f1c40f', '#3498db', '#1abc9c', '#95a5a6'];
  ...
  {/* FILTER BAR */}
  <div className="w-full bg-gray-500 p-4 rounded text-white shadow-lg flex flex-wrap items-center justify-between gap-4">
    <div className="flex items-center gap-2">
      <label className="text-sm sm:text-base font-medium">Filter by Category:</label>
      <select
        value={category}
    ...
    <div className="flex flex-wrap gap-4">
      {Object.keys(visible).map((key) => (
        <label key={key} className="flex items-center gap-2 text-sm sm:text-base">
          <input
            type="checkbox"
            checked={visible[key]}
  ...
  <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
    {visible.map && (
      <div className="bg-white p-4 rounded shadow relative min-w-0">
        <div className="absolute top-2 left-2 bg-green-600 text-white text-lg font-bold px-6 py-1 rounded">
          12.4%
        </div>
        <h3 className="text-base md:text-lg font-semibold mb-4">Global Coverage</h3>
        <WorldMapView />
      </div>
    )}

    {visible.calendar && (
      <div className="bg-white p-4 rounded shadow h-[45vh] min-w-0">
        <h3 className="text-base md:text-lg font-semibold mb-4">Calendar</h3>
    ...
    {visible.projects && (
      <div className="bg-white p-4 rounded shadow min-w-0">
        <h3 className="text-base md:text-lg font-semibold mb-4">Active Projects</h3>
  ...
  <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
    {visible.assigned && (
      <div className="bg-white p-4 rounded shadow flex flex-col min-w-0">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-base md:text-lg font-semibold">Assigned To You (ClickUp)</h3>
          <a
        ...
        <div className="bg-gray-100 rounded overflow-hidden">
          <img src="/assets/clickup.png" alt="ClickUp Screenshot" className="w-full" />
        </div>
      </div>
    )}
    ...
    {visible.news && (
      <div className="bg-white p-4 rounded shadow min-w-0">
        <h3 className="text-base md:text-lg font-semibold mb-4">Latest News</h3>
    ...
    {visible.projects && (
      <div className="bg-white p-4 rounded shadow min-w-0">
        <h3 className="text-base md:text-lg font-semibold mb-4">Current Projects</h3>
        <div className="grid gap-2">
          ...
          <div className="bg-blue-50 p-2 rounded shadow-md">
            <h4 className="font-medium text-sm">Manage Event Planning</h4>
